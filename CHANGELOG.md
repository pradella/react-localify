...
## [2.0.4-alpha.0] - 2025-11-19

### Fixed

- Fixed `setMessages` to properly deep merge locale translations instead of replacing them, preserving existing translations for other locales
